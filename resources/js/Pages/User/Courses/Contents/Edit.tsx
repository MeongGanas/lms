...
import { Breadcrumbs, Content, PageProps, Topic } from "@/types";
...
export default function Edit({ auth: { user }, content, topic, breadcrumbs }: PageProps<{ content: Content; topic: Topic; breadcrumbs: Breadcrumbs[] }>) {
    ...
    const submit = handleSubmit((values) => {
        ...
        if (values.external_url || content.external_url) {
