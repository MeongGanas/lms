...
import { Content, SubmissionFile, TempFile } from "@/types"
...
export function UploadedFileCard({ tempFile, content, user_id }: { tempFile: TempFile | SubmissionFile, content?: Content; user_id?: string }) {
    const queryClient = useQueryClient();

    const deleteTempFiles = (e: SyntheticEvent, tempFile: TempFile | SubmissionFile) => {
        e.preventDefault()
